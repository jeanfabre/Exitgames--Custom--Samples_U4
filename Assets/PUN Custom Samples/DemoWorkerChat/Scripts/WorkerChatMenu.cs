...
public class WorkerChatMenu : MonoBehaviour
{
	public PunAndChatConnection ConnectionManager;



	public GameObject UserNameUiForm;
    ...
    public static readonly string SceneNameMenu = "DemoWorkerChat-Scene";

    public static readonly string SceneNameGame = "DemoWorkerChatGame-Scene";
	...
	{
		ConnectionManager.UserId = userName;
